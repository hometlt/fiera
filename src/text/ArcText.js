 ...
 */
import {sectorBoundingBox} from "../util/geometry.js";
...
export const FmArcText = {
  ...
  prototypes: {
    Canvas: {
      showControlsGuidlines: true,
    },
    ArcText: {
      type: "arc-text",
      "+_styleProperties": ["contourStroke","contourStrokeWidth"],
      ...
      createCurvatureControl() {
        ...
        this.controls.c = new fabric.Control({
          x: 0,
          y: 0,
          offsetX: 0,
        ...
        this.on("scaling","updateCurvingControl")
      },
      ...
      changeCurvature(eventData, transform, x, y) {
        var target = transform.target;
        let localPoint = fabric.controlsUtils.getLocalPoint(transform, transform.originX, transform.originY, x, y),
    ...
    Text: {
      ...
      curvature: 0,
      setRadius(value){
        this.setCurvature(value ? 10000 / value: false)
      },
      setCurvature(value) {
