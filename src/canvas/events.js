...
var _onMouseMove_overwritten = fabric.Canvas.prototype._onMouseMove;
...
var fire_overwritten = fabric.Canvas.prototype.fire;
...
fabric.util.object.extend(fabric.Canvas.prototype, {
  ...
  fire (event, options){
    fire_overwritten.call(this,event, options)
    if(this.editor){
      if(!options)options = {}
      let _canvas = options.canvas;
      options.canvas = this;
      this.editor.fire("canvas:" + event, options)
...
//       // To unify the behavior, he object's double click event does not fire on drawing mode.
...
//     }
  ...
  _onMouseMove: function (e) {
    ...
    _onMouseMove_overwritten.call(this, e);
  },
