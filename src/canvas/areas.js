...
export default {
  ...
  prototypes: {
    ...
    Canvas :{
      backdropColor: false,//"rgba(0,0,0,0.1)",
      renderBackdrop: function() {
        if(!this._areasObjects || !this._areasObjects.length || !this.backdropColor){
          return
        }
