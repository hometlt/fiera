export default function SVGtoPDF(doc, svg, x, y, options) {
    "use strict";
    ...
    options = options || {};
    var pxToPt = options.pxToPt || ( options.assumePt ? 1 : (72/96)), // 1px = 72/96pt, but only if assumePt is false
