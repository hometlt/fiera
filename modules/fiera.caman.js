...
fabric.Image.filters.Custom = fabric.util.createClass(fabric.Image.filters.BaseFilter, {
  type: 'custom',
  parameters: [
    "brightness",
    "contrast",
...
fabric.Image.filters.Custom.prototype.options = {
...
fabric.Image.filters.Custom.prototype.custom = true;
fabric.Image.filters.Custom.prototype.caman = true;

fabric.Image.filters.Custom.fromObject = function (o) {
  return new fabric.Image.filters.Custom(o)
};
