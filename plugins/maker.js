...
// private utility functions
        ...
        3: [function (require, module, exports) {
            ...
            ConvexHullGrahamScan.prototype = {
                constructor: ConvexHullGrahamScan, Point: function (n, t) {
                    this.x = n, this.y = t
                    ...
                    function getAllCaptionsOffset(modelContext) {
                        ...
                        function tryAddCaption(m, offset, layer) {
                            if (m.caption) {
                                captions.push({
                                    text: m.caption.text,
                                    anchor: MakerJs.path.clone(m.caption.anchor, offset),
                    ...
                    function toSVG(itemToExport, options) {
                        ...
                        if (opts.useSvgPathOnly) {
                            ...
                            function addFlowMarks(flow, layer, origin, end, endAngle) {
                                ...
                                var arrowLines = [arrowEnd, MakerJs.point.mirror(arrowEnd, false, true)].map(function (p) {
                ...
                (function (models) {
                    ...
                    function getChainBezierRange(curve, c, layer, addToLayer) {
                        ...
                        var actualBezierRanges = endLinks.map(function (endLink) {
                            return getActualBezierRange(curve, endLink.walkedPath.pathContext, endLink.endPoints, endLink.walkedPath.offset);
                        });
                        var result = {
