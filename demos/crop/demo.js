...
import ImageCrop    from '../../src/images/image-crop.js'
import OuterCanvas  from '../../src/canvas/outer-canvas.js'

fabric.installPlugins([ImageCrop, OuterCanvas])


fabric.mediaRoot = "http://cdn.hometlt.ru/"

//setting up the Canvas
const canvas = window.canvas = new fabric.Canvas('canvas')
canvas.setDimensions({width: document.body.clientWidth - 100, height: document.body.clientHeight- 60})
// canvas.setViewportTransform([0.5, 0, 0, 0.5, 0, 0])

//controls overflow
canvas.setOuterCanvasContainer("outer");
canvas.setOuterCanvasOpacity(0.5);
